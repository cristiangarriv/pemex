...
public class EmpleadosAdapterConsulta extends RecyclerView.Adapter<EmpleadosAdapterConsulta.ViewHolder> {
    ...
    public EmpleadosAdapterConsulta(List<Empleados.Empleado> empleadoList, OnItemClickListener listener) {
